...
public partial class ChangelogOverlay : Control
{
    ...
    private const string ChangelogText =
        ...
        "· 死神登场静止期间整体发冷色，一眼能看出减伤还没结束\n" +
        "· 去掉 BOSS 移动时精灵左右摇摆 ±10 度的效果（俯视角看起来像角色在晃）\n" +
        "· 新增最终 BOSS「死神 Reaper」：2400 点血、10 个技能，配肖邦《冬风》练习曲\n" +
        "· 数值调整：大橘 1200 → 800 点血、死神 1200 → 2400 点血（犀牛保持 1200）\n" +
        "· 大橘改为「低血量、高攻击」：四个技能伤害 2/2/2/3 → 4/4/4/6，贴身抓挠 1 → 2\n" +
